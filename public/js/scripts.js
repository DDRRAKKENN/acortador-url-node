...
formulario.addEventListener('submit', async e => {
    ...
    if(resultado.codigo === 201) {
        ...
        mensaje.innerHTML = `<p>Se ha acortado correctamente la URL!<a target="_blank" rel="noopener noreferrer" href="/${resultado.url}"> CLICK AQUI</a> </p> `;
...
if(urlParams.has('error')) {
    ...
    const mensaje = document.createElement('div');
    mensaje.classList.add('mensaje-url', 'error');
    mensaje.innerHTML = `<p>URL no válida, intenta nuevamente</p>`;
